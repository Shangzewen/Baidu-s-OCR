...
filename_prefix = "ACR"
csv_file = "Book1.csv"
pdf_file = "emptyform.pdf"
tmp_file = "tmp.fdf"
output_folder = '/Users/huaihaizi/Desktop/Term7/Capstone/Data/output'
...
def form_fill(fields):
    fdf = forge_fdf("", fields, [], [], []).decode('latin-1')
    # print(fdf)
    fdf_file = open(tmp_file, "w", encoding='utf-8')
    fdf_file.write(fdf)
    fdf_file.close()
